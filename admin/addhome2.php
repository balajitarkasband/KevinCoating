        ...
        <div class="wrapper">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <table class="tbl-30">
                    ...
                    <label for="category">Choose a category:</label>
                        ...
                        <option value="Corosol1">Corosol1</option>
                        <option value="Corosol2">Corosol2</option>
                        <option value="Corosol3">Corosol3</option>
            ...
            <?php
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    $sql2 = "INSERT INTO Home(img, `desc`, imgcat) VALUES('$img','$description1','$imgcat')"; 
