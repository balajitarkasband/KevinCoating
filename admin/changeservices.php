...
<body class ="container">
    ...
    <tr>
        ...
        <th><a href="addservices.php">Add Info</a></th>
    </tr>
        ...
        if($count>0)
        {
            ...
            while($row=mysqli_fetch_assoc($res))
            {
                ...
                <tr>
                        ...
                        <td>
                            <a href="updateservice.php?id=<?php echo $id;?>" class="btn-secondary">Update</a>
                            <a href="deleteservice.php?id=<?php echo $id; ?>&image_name=<?php echo $img1; ?>" class="btn-danger">Delete</a>
                        </td>
                </tr>
