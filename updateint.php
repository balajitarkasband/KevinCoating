...
<?php
    ...
    if(isset($_GET['id']))
    {
        ...
        $sql2 = "SELECT * FROM interior WHERE i_id=$id";
        ...
        $title = $row2['i_products'];
        $current_image = $row2['i_images'];
...
<div class="main-content">
    <div class="wrapper">
        <h1>Update Interior Products</h1>
        <br><br>
        ...
        <table class="tbl-30">
            ...
            <tr>
                <td>
                    ...
                    <input type="submit" name="submit" value="Update Interior" class="btn-secondary">
                </td>
            </tr>
