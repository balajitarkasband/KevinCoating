  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.3.1/dist/css/bootstrap.min.css"
    ...
    <!-- Main Section Starts -->
        <div class="main-content">
            <div class="wrapper">
                <h1>Manage exterior products</h1>
                <br><br><br>
                ...
                <!-- Button to Add Admin-->
                <a href="addexteriorpro.php" class="btn-primary">Add Exterior Products</a>
                            ...
                            if($res==TRUE)
                            {
                                ...
                                if($count>0)
                                {
                                    ...
                                    while($rows=mysqli_fetch_assoc($res))
                                    {
                                        ...
                                        //Get individual data
                                        $id=$rows['e_id'];
                                        $products=$rows['e_products'];
                                        $image_name=$rows['eimage'];
                                        ...
                                        ?>
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                <a href="updateext.php?id=<?php echo $id;?>" class="btn-secondary">Update Exterior</a>
                                                <a href="deleteext.php?id=<?php echo $id;?>&image_name=<?php echo $image_name;?>" class="btn-danger">Delete Exterior</a>
                                            </td>
                                        </tr>                     
