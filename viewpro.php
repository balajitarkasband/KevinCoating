    ...
    <!-- Main Section Starts -->
        <div class="main-content">
            <div class="wrapper">
                ...
                <!-- Button to Add Admin-->
                <a href="addproducts.php" class="btn-primary">Add Products</a>
                                    ...
                                    while($rows=mysqli_fetch_assoc($res))
                                    {
                                        ...
                                        ?>
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                <a href="updatepro.php?id=<?php echo $id;?>" class="btn-secondary">Update products</a>
                                                <a href="deletepro.php?id=<?php echo $id;?>&image_name=<?php echo $image_name;?>" class="btn-danger">Delete Products</a>
                                            </td>
                                        </tr>                     
